...
/**
 * Register a 'field' taxonomy for post type 'book', with a rewrite to match book CPT slug.
 *
...
/**
 * Register a 'location' taxonomy for post type 'book', with a rewrite to match book CPT slug.
 *
 * @see register_post_type for registering post types.
 */
...
/**
 * Register a 'company' taxonomy for post type 'book', with a rewrite to match book CPT slug.
 *
 * @see register_post_type for registering post types.
 */
