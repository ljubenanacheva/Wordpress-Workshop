	...
	<?php while( have_posts() ): ?>
		...
		<div class="job-single">
			...
			<aside class="job-secondary">
				...
				<a href="#" id="<?php echo get_the_ID(); ?>" class="like-button">Like (<?php echo get_post_meta( get_the_ID(), 'likes', true ) ?>)</a>
		...
		<?php softuni_display_other_jobs_per_company( get_the_ID() ); ?>
